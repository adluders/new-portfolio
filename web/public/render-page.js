...
})(["font-size:4rem;@media screen and (max-width:505px){font-size:3rem;}"]);
const SubTitle = styled_components__WEBPACK_IMPORTED_MODULE_2__.default.p.withConfig({
...
})(["font-size:2rem;text-align:center;margin:2.3rem auto;"]);
...
})(["border-bottom:1px solid transparent;color:#888;&:hover{color:#000;}"]);
const navLinks = [{
  id: 1,
  path: "/portfolio",
  text: "Portfolio"
